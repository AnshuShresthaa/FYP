...
const Footer = () => {
  ...
  <footer className="container mx-auto grid grid-cols-10 px-5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 lg:gap-x-10">
    <div className="col-span-5 md:col-span-4 lg:col-span-2 flex items-center">
    ...
    <div className="col-span-5 md:col-span-4 md:col-start-5 lg:col-start-auto lg:col-span-2 flex items-center">
      <div className="mx-auto">
    ...
    <div className="col-span-5 md:col-span-4 lg:col-span-2 flex items-center">
      <div className="mx-auto">
        ...
        <div className="col-span-10 md:order-first md:col-span-4 lg:col-span-2">
          ...
          Take a moment for self-care, connect with loved ones, and remember that you are not alone on your journey.
          </p>
